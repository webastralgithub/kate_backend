...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <span class="brand-text font-weight-light">Bless</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item">
            <a href="{{ url('home') }}" class="nav-link {{ @$title['active']=='home' ? 'active' : '' }}">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>Dashboard</p>
            </a>
          </li>
           <li class="nav-item">
            <a href="{{ url('users') }}" class="nav-link {{ @$title['active']=='users' ? 'active' : '' }}">
         ...
         <!--<li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
            <a href="{{ url('get_request') }}" class="nav-link">
              <i class="nav-icon far fa-circle text-warning"></i>
              <p>Payment-Status</p>
            </a>
          </li> -->
